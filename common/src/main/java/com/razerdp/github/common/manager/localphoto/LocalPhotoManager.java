package com.razerdp.github.common.manager.localphoto;
...
import com.razerdp.github.common.entity.ImageInfo;
import com.razerdp.github.lib.api.AppContext;
import com.razerdp.github.lib.helper.AppFileHelper;
import com.razerdp.github.lib.helper.SharePreferenceHelper;
import com.razerdp.github.lib.manager.ThreadPoolManager;
import com.razerdp.github.lib.utils.FileUtil;
import com.razerdp.github.lib.utils.GsonUtil;
import com.razerdp.github.lib.utils.KLog;
import com.razerdp.github.lib.utils.TimeUtil;
import com.razerdp.github.lib.utils.WeakHandler;
...
public enum LocalPhotoManager {
    ...
    private synchronized void scanImgInternal(@Nullable OnScanListener listener) {
        ...
        isScaning = true;
        callStart(listener);
        lastScanTime = SharePreferenceHelper.loadLongPreferenceByKey(SharePreferenceHelper.APP_LAST_SCAN_IMG_TIME, 0);
    ...
    private void scan(LinkedHashMap<String, List<ImageInfo>> sALBUM, @Nullable OnScanListener listener) {
        ...
        SharePreferenceHelper.saveLongPreferenceByKey(SharePreferenceHelper.APP_LAST_SCAN_IMG_TIME, lastScanTime);
        cursor.close();
        callFinish(listener);
        reset();
        KLog.i(TAG, "scan完成");
